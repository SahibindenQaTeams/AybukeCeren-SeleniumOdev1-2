...
public class IndividualCSS {
    ...
    private List<String> alanlarınId = Arrays.asList("name", "surname", "email","password");
    private List<String> alanInputları = Arrays.asList("Ceren", "Duran", "cxy" + Double.toString(Math.random()*100) + "@mailinator.com", "password1234");
    ...
    public void test(){
        ...
        WebElement cookieAccept = driver.findElement(By.cssSelector("#onetrust-accept-btn-handler"));
        cookieAccept.click();
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#viewEmail")));
