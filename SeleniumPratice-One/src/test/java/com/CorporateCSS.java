...
public class CorporateCSS {
    ...
    public void test(){
        ...
        {
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#" +alanlarınId.get(i))));
            element = driver.findElement(By.cssSelector("#" +alanlarınId.get(i)));
        ...
        for(int i =0; i<selectSayısı1; i++)
        {
            ...
            select = new Select(driver.findElement(By.cssSelector("#" +selectId1.get(i))));
            wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("#" +selectId1.get(i))));
        ...
        System.out.println("İşletma türü seçimi yapıldı");

        for(int i =0; i<selectSayısı2; i++)
        {
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#" +selectId2.get(i))));
            select = new Select(driver.findElement(By.cssSelector("#" +selectId2.get(i))));
            wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("#" +(selectId2.get(i)))));
        ...
        element = driver.findElement(By.cssSelector("#taxNumber"));
        ...
        element  = driver.findElement(By.cssSelector("#confirmSubmit"));
        element.click();
